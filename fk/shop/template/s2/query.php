...
<html data-dpr="1" style="font-size: 39px;">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="template/s2/static/favicon.ico">
		<link href="template/s2/static/css/main.css" rel="stylesheet">
	...
	<body style="font-size: 12px;background: #f7f7f7">
			...
			<div id="checking_order" class="Router" style="position:relative">
				<div class="checking_order_hide">
					<div class="back" onclick="history.back();">
						<img src="template/s2/static/img/back.png">
					</div>
					<div class="tous">
						<img src="template/s2/static/img/after.png">
						<span>申请售后</span>
					</div>
				</div>
				...
				<div class="suoding">
				    <form id="form">
					<img src="template/s2/static/img/card.png" class="dasuo_img">
					<div class="suoding_text_box">
						<span>查询订单卡密</span>
						<span>填写下单时留的联系方式,或使用"card"开头的订单号查询</span>
					</div>
					<div class="input_box">
						<img src="template/s2/static/img/order.png">
				...
				<div class="wxtihs">
					<div class="wxtihs_hide">
						<img src="template/s2/static/img/warning.png">
        ...
        <script src="template/s2/static/js/main.js"></script>
	</body>
</html>