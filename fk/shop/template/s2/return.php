...
<div class="main">
    ...
    <?php
            echo '<div><img src="template/s2/static/img/order.png" style="height:20px;margin-right:10px;vertical-align:top;"><span style="color:#4A30DB;font-weight:bold;">订单信息</span></div>
            ...
            echo '<div><img src="template/s2/static/img/product.png" style="height:20px;margin-right:10px;vertical-align:top;"><span style="color:#4A30DB;font-weight:bold;">发货内容</span></div><div style="font-size:14px;margin-top:20px;color:#999;margin-bottom:20px;">'.str_replace("||","<br>",$O["O_content"]).'</div>';
            
            echo '<div><img src="template/s2/static/img/intro.png" style="height:20px;margin-right:10px;vertical-align:top;"><span style="color:#4A30DB;font-weight:bold;">使用方法</span></div><div style="font-size:14px;margin-top:20px;color:#999">'.str_replace("\r\n","<br>",htmlspecialchars($P["P_use"])).'</div>';
    ?>
</div>
    </div>
</body>
